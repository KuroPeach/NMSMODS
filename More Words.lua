...
KnowledgeStone = 10 -- words learn from knowledge stones
WordStation    = 10 -- words learn from word stations/encyclopedias
Monolith       = 10 -- Monolith seek help with language option
Monolith_Atlas = 10 -- Monolith atlas word reward from multiple choice questions
Atlas_Orb      = 10 -- Glowing orbs on the atlas stations
-------------------------
...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  ["MOD_DESCRIPTION"]     =
  "Increases the amount of words learn from NPCs, Knowledge Stones, Encyclopedias, Monoliths, and Atlas Orbs",
  ["NMS_VERSION"]         = "5.12",
  ...
  {
    {
      ["MBIN_CHANGE_TABLE"] =
      {
        ...
        {
          ["MBIN_FILE_SOURCE"] =
          "MODELS\PLANETS\BIOMES\COMMON\BUILDINGS\PROPS\INTERACTIVE\WORDSTATION\ENTITIES\WORDSTATION.ENTITY.MBIN",
          ["EXML_CHANGE_TABLE"] =
          {
            {
              ["SPECIAL_KEY_WORDS"] = { "Reward", "WORD" },
        ...
        {
          ["MBIN_FILE_SOURCE"] =
          "MODELS\SPACE\ATLASSTATION\MODULARPARTS\INTERIOR\PATHORB\PATHORB\ENTITIES\ORBSTONE_1.ENTITY.MBIN",
          ["EXML_CHANGE_TABLE"] =
          {
            {

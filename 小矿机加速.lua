...
FuelTime =
"15"             -- How much time until the Fuel is fully used in seconds, 300 equals 5 minutes. When editing make sure it's a positive number.
WorkTime =
"-15"            -- How much time until it's full in seconds, 300 equals 5 minutes. When changing make sure it's negative number.
